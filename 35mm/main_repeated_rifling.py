...
from repeated_rifling import repeated_rifling
...
def main():
    # ------------ knobs ------------
    steel = "30HN2MFA"
    tCr_um = 30              # Chromium layer thickness [um]

    # Meshing - Radial-Axisymmetric-Structured
    Nr = 200 * 4             # Number of Radial grid points
    Nz = 6                   # Number of Axial grid points
...
# Time March Parameters
    ...
    cool_tail_s = 5.00       # cooldown time after last heating [s]
